...
public class Protocol {
    ...
    public static final String RICHIESTA_DOWNLOAD_DA_NODO = "RICHIESTA_DOWNLOAD_DA_NODO";
    public static final String RICHIESTA_DOWNLOAD_DA_RETE = "RICHIESTA_DOWNLOAD_DA_RETE";
    public static final String RICHIESTA_LISTA_NODI = "RICHIESTA_LISTA_NODI";
    ...
    public static final String TUTTO_OK = "OK";
